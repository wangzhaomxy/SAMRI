...
ckpt_list = [
            ...
            #  ckpt_root_path + model_folder + "samri_vitb_box_17.pth",
            #  ckpt_root_path + model_folder + "samri_vitb_box_18.pth",
             ckpt_root_path + model_folder + "samri_vitb_box_21.pth",
             ckpt_root_path + model_folder + "samri_vitb_box_22.pth",
             ]
