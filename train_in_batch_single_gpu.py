...
model_save_path = MODEL_SAVE_PATH + "b384e20lr4/"
device = DEVICE
...
def main():
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if (epoch + 1) % 1 == 0:
            ...
            torch.save(samri_model.state_dict(), join(model_save_path, f"samri_vitb_b384e20lr4_{str(epoch+1)}.pth"))
            print(f"Checkpoint <samri_vitb_b384e20lr4_{str(epoch+1)}.pth> has been saved.")
