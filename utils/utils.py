...
BATCH_SIZE = 1024 # The batch size for training. For Mi300x 192GB GPU, 1024 is recommended. For H100 80GB GPU, 512 is recommended.
...
VAL_ZEROSHOT_PATH = [ds + "/validation/" for ds in sorted(glob(TEST_ZERO_PATH + "*"))]
TRAIM_ZEROSHOT_PATH = [ds + "/training/" for ds in sorted(glob(TEST_ZERO_PATH + "*"))]
